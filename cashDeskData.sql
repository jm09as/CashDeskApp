...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_hu_0900_ai_ci;
...
LOCK TABLES `cash_desk` WRITE;
/*!40000 ALTER TABLE `cash_desk` DISABLE KEYS */;
INSERT INTO `cash_desk` VALUES (1,'protoType',1,'2022-08-13 00:00:00');
/*!40000 ALTER TABLE `cash_desk` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping data for table `cash_registry`
--

LOCK TABLES `cash_registry` WRITE;
/*!40000 ALTER TABLE `cash_registry` DISABLE KEYS */;
INSERT INTO `cash_registry` VALUES (1,'2022-08-13 00:00:00','protoOne',1,1);
/*!40000 ALTER TABLE `cash_registry` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-08-13 17:06:30
